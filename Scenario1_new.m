...
for i = 1:number_time_nodes-1
    ...
    for m = current_distance_node:number_fluid_nodes-1
        temperature_matrix(i+1, m) = dual_conduction(temperature_matrix(i, m-1), ...
            ...
            cross_areas(m-1), k_fluid, cross_areas(m), rho_fluid, rho_fluid, C_p_fluid, C_p_fluid, ...
            delta_x, delta_t);
    ...
    for m = current_distance_node:current_distance_node
        temperature_matrix(i+1, m) = dual_conduction(temperature_matrix(i, m-1), temperature_matrix(i, m), temperature_matrix(i, m+1), ...
            k_fluid, cross_areas(m-1), k_insulation, cross_areas(m), rho_fluid, rho_insulation, C_p_fluid, C_p_insulation, ...
            delta_x, delta_t);
    ...
    if number_insulation_nodes > 1 % changed 
        ...
        for m = current_distance_node:current_distance_node+number_insulation_nodes-3
            temperature_matrix(i+1, m) = dual_conduction(temperature_matrix(i, m-1), temperature_matrix(i, m), temperature_matrix(i, m+1), ...
                k_insulation, cross_areas(m-1), k_insulation, cross_areas(m), rho_insulation, rho_insulation, C_p_insulation, C_p_insulation, ...
                delta_x, delta_t);
            nodes_added = m-current_distance_node+1;
        end
        current_distance_node = current_distance_node + nodes_added;
    ...
    if number_vacuum_nodes > 1
        ...
        for m = current_distance_node:current_distance_node
            ...
            %    delta_x, delta_t);
            temperature_matrix(i+1, m) = temperature_matrix(i, m-1); % reza wants me to test this
            nodes_added = m-current_distance_node+1;
        end
        current_distance_node = current_distance_node + nodes_added;
        nodes_added = 0;
    ...
    if number_insulation_2_nodes > 1
        ...
        for m = current_distance_node:current_distance_node+number_insulation_2_nodes-3
            temperature_matrix(i+1, m) = dual_conduction(temperature_matrix(i, m-1), temperature_matrix(i, m), temperature_matrix(i, m+1), ...
                k_insulation_2, cross_areas(m-1), k_insulation_2, cross_areas(m), rho_insulation_2, rho_insulation_2, C_p_insulation_2, C_p_insulation_2, ...
                delta_x, delta_t);
        ...
        for m = current_distance_node:current_distance_node
            temperature_matrix(i+1, m) = dual_conduction(temperature_matrix(i, m-1), temperature_matrix(i, m), temperature_matrix(i, m+1), ...
                k_insulation_2, cross_areas(m-1), k_insulation_2, cross_areas(m), rho_insulation_2, rho_metal, C_p_insulation_2, C_p_metal, ...
                delta_x, delta_t);
